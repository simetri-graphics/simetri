...
It is designed to be used in conjunction with XeLaTeX rendering engine. Currently the project is in its late alpha stages and is not ready for production use. Source code is available at [https://github.com/mekanimo/simetri](https://github.com/mekanimo/simetri). Although this version is a proof of concept and is likely to change significantly in the future, it is already capable of producing some interesting results.
